...
public static class StoragePersistenceManager
{
    ...
    private static readonly Dictionary<int, List<SavedWeaponData>> _storedWeapons = [];
    ...
    public static void SaveStoredWeapons(int playerId, List<SavedWeaponData> weapons)
    {
        ...
        _storedWeapons[playerId] = [.. weapons];

    }

    public static List<SavedWeaponData> GetStoredWeapons(int playerId) => _storedWeapons.TryGetValue(playerId, out var list) ? list : null;
    ...
    public static void ClearAllStoredWeapons() => _storedWeapons.Clear();
}
