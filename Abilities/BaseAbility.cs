...
public abstract class BaseAbility : MonoBehaviour
{
    ...
    private static readonly Dictionary<int, float> lastAbilityNotReadySoundTimeByPlayer = [];
    ...
    public virtual string[] ActivationButtons
    {
        get
        {
            ...
            return [Consts.Values.Inputs.KeyboardQ, gamepadButton];
        }
    }
    ...
    protected virtual void Awake() => playerInput = GetComponentInParent<PlayerInput>();
    ...
    protected virtual void CreateAbilityIndicator()
    {
        ...
        GameObject indicatorObj = new($"{GetType().Name}_Indicator");
    ...
    public virtual bool IsOnCooldown() => onCooldown;
    ...
    protected virtual bool ShouldPlayAbilityEndedSound(bool wasUltimate) => true;
