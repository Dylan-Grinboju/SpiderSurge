...
namespace SpiderSurge
{
    ...
    {
        private static readonly List<RailShot> _all = new List<RailShot>();
    ...
    {
        [HarmonyPostfix]
        private static void Postfix(RailShot __instance)
        {
            RailShotTracker.Register(__instance);
        }
    }
    ...
    internal static class RailShot_StopProjectile_TrackingPatch
    {
        ...
        private static void Postfix(RailShot __instance)
        {
            RailShotTracker.Unregister(__instance);
        }
    }
