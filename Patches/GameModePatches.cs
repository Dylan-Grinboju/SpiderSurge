...
{
    [HarmonyPostfix]
    public static void Postfix() => GameModePatches.UpdateSurgeSurvivalText();
}
...
{
    private static string GetSurvivalModeDisplayName() => ModConfig.enableSurgeMode ? "Surge Survival" : "Wave Survival";
