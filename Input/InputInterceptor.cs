...
{
    private static readonly Dictionary<PlayerInput, InputInterceptor> playerInterceptors = [];
    ...
    private readonly Dictionary<string, List<BindingRestoreInfo>> restoredBindings = [];
