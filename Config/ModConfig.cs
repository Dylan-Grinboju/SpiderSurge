...
public static class ModConfig
{
    ...
    public static void SetEnableSurgeMode(bool value) => Config.SetModConfigValue(ModId, "EnableSurgeMode", value);

    public static void SetShowTutorial(bool value) => Config.SetModConfigValue(ModId, "display.showTutorial", value);

    public static void SetTelemetryEnabled(bool value) => Config.SetModConfigValue(ModId, "TelemetryEnabled", value);

    public static void SetShowTelemetryConsentPrompt(bool value) => Config.SetModConfigValue(ModId, "display.showTelemetryConsentPrompt", value);
