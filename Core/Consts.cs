    ...
    public static class Consts
    {
        ...
        public static class Values
        {
            ...
            public static readonly Dictionary<string, EnemySpawnConfig> CustomEnemyStats = new Dictionary<string, EnemySpawnConfig>
                {
                    { "Wasp", new EnemySpawnConfig(1.5f, 0, 14) },
                    { "Roller", new EnemySpawnConfig(1.5f, 2, 18) },
                    { "Whisp", new EnemySpawnConfig(2f, 4, 20) },
                    { "MeleeWhisp", new EnemySpawnConfig(2f, 6, 20) },
                    { "Khepri", new EnemySpawnConfig(2.5f, 8, 24) },
                    { "ExplodingRoller", new EnemySpawnConfig(3f, 10, 0) },
                    { "PowerWhisp Variant", new EnemySpawnConfig(3f, 12, 0) },
                    { "PowerWasp Variant", new EnemySpawnConfig(3f, 14, 32) },
                    { "TwinBladeMeleeWhisp", new EnemySpawnConfig(4f, 16, 36) },
                    { "PowerRoller Variant", new EnemySpawnConfig(4f, 18, 0) },
                    { "PowerKhepri Variant", new EnemySpawnConfig(4f, 20, 0) },
                    { "PowerMeleeWhisp Variant", new EnemySpawnConfig(4f, 22, 40) },
                    { "TwinWhisp", new EnemySpawnConfig(4f, 24, 34) },
                    { "Wasp Shielded", new EnemySpawnConfig(4f, 26, 42) },
                    ...
                    { "Hornet Variant", new EnemySpawnConfig(6f, 36, 50) },
                    { "MissileWhisp", new EnemySpawnConfig(7f, 38, 56) },
