...
public class PerksManager : MonoBehaviour
{
    ...
    private readonly HashSet<string> abilityPerks = [Consts.PerkNames.ImmuneAbility, Consts.PerkNames.AmmoAbility, Consts.PerkNames.PulseAbility, Consts.PerkNames.StorageAbility];

    // Upgrade perks - shown in normal perk selection
    private readonly HashSet<string> upgradePerks = [Consts.PerkNames.AbilityCooldown, Consts.PerkNames.AbilityDuration, Consts.PerkNames.ShortTermInvestment, Consts.PerkNames.LongTermInvestment, Consts.PerkNames.PerkLuck];

    // Ability Ultimate perks - Ultimate versions of abilities (requires base ability)
    private readonly HashSet<string> abilityUltimatePerks = [Consts.PerkNames.ImmuneAbilityUltimate, Consts.PerkNames.AmmoAbilityUltimate, Consts.PerkNames.PulseAbilityUltimate, Consts.PerkNames.StorageAbilityUltimate];



    private readonly Dictionary<string, int> maxLevels = new()
    {
    ...
    private readonly Dictionary<string, List<string>> dependencies = new()
    {
        [Consts.PerkNames.ImmuneAbility] = [],
        [Consts.PerkNames.AmmoAbility] = [],
        [Consts.PerkNames.PulseAbility] = [],
        [Consts.PerkNames.StorageAbility] = [],
        [Consts.PerkNames.AbilityCooldown] = [],
        [Consts.PerkNames.AbilityDuration] = [],
        [Consts.PerkNames.ShortTermInvestment] = [],
        [Consts.PerkNames.LongTermInvestment] = [],
        [Consts.PerkNames.PerkLuck] = [],
        // Ultimate perks require the base ability to be unlocked
        [Consts.PerkNames.ImmuneAbilityUltimate] = [Consts.PerkNames.ImmuneAbility],
        [Consts.PerkNames.AmmoAbilityUltimate] = [Consts.PerkNames.AmmoAbility],
        [Consts.PerkNames.PulseAbilityUltimate] = [Consts.PerkNames.PulseAbility],
        [Consts.PerkNames.StorageAbilityUltimate] = [Consts.PerkNames.StorageAbility]
    };

    private readonly Dictionary<string, int> perkLevels = [];
    ...
    public static void EnableImmuneAbility() => EnableAbility<ImmuneAbility>(Consts.PerkNames.ImmuneAbility);

    public static void EnableAmmoAbility() => EnableAbility<AmmoAbility>(Consts.PerkNames.AmmoAbility);

    public static void EnablePulseAbility() => EnableAbility<PulseAbility>(Consts.PerkNames.PulseAbility);

    public static void EnableStorageAbility() => EnableAbility<StorageAbility>(Consts.PerkNames.StorageAbility);

    public static void EnableImmuneUltimate() => EnableUltimate<ImmuneAbility>(Consts.PerkNames.ImmuneAbilityUltimate);

    public static void EnableAmmoUltimate() => EnableUltimate<AmmoAbility>(Consts.PerkNames.AmmoAbilityUltimate);

    public static void EnablePulseUltimate() => EnableUltimate<PulseAbility>(Consts.PerkNames.PulseAbilityUltimate);

    public static void EnableStorageUltimate() => EnableUltimate<StorageAbility>(Consts.PerkNames.StorageAbilityUltimate);
    ...
    public bool IsAbilityPerk(string perkName) => abilityPerks.Contains(perkName);

    public bool IsUpgradePerk(string perkName) => upgradePerks.Contains(perkName);

    public IEnumerable<string> GetAbilityPerkNames() => abilityPerks;

    public IEnumerable<string> GetUpgradePerkNames() => upgradePerks;

    public IEnumerable<string> GetAbilityUltimatePerkNames() => abilityUltimatePerks;

    public int GetPerkLevel(string perkName) => perkLevels.ContainsKey(perkName) ? perkLevels[perkName] : 0;
    ...
    public bool IsAvailable(string perkName)
    {
        ...
        if (perkName is Consts.PerkNames.ShortTermInvestment or Consts.PerkNames.LongTermInvestment)
        {
            if (!HasAnyUltimate()) return false;
        }
    ...
    public bool HasAnyAbilityUnlocked() => GetPerkLevel(Consts.PerkNames.ImmuneAbility) > 0 || GetPerkLevel(Consts.PerkNames.AmmoAbility) > 0 || GetPerkLevel(Consts.PerkNames.PulseAbility) > 0 || GetPerkLevel(Consts.PerkNames.StorageAbility) > 0;
    ...
    public string GetChosenAbilityUltimate()
    {
        ...
        return GetPerkLevel(Consts.PerkNames.PulseAbility) > 0
            ? Consts.PerkNames.PulseAbilityUltimate
            : GetPerkLevel(Consts.PerkNames.StorageAbility) > 0 ? Consts.PerkNames.StorageAbilityUltimate : null;
    }
    ...
    public void SetPerkLevel(string perkKey, int level) => perkLevels[perkKey] = level;
    ...
    public float GetPerkLuckChance()
    {
        ...
        return level == 1 ? Consts.Values.Luck.Level1Chance : level == 2 ? Consts.Values.Luck.Level2Chance : 0f;
    }
