...
public class TutorialUI : MonoBehaviour
{
    ...
    #region Colors
    private static readonly Color Blue = new(0.259f, 0.522f, 0.957f, 1f);
    private static readonly Color Red = new(1f, 0.341f, 0.133f, 1f);
    private static readonly Color Green = new(0.298f, 0.686f, 0.314f, 1f);
    private static readonly Color White = new(0.9f, 0.9f, 0.9f, 1f);
    private static readonly Color DarkGray = new(0.10f, 0.10f, 0.10f, 0.98f);
    private static readonly Color MediumGray = new(0.20f, 0.20f, 0.20f, 0.95f);
    private static readonly Color Orange = new(1f, 0.647f, 0f, 1f);
    #endregion
    ...
    private void OnGUI()
    {
        ...
        DrawSection("HOW TO ACTIVATE ABILITIES", [
        ...
        DrawSection("CUSTOMIZE CONTROLS", [
            "Set New Ability Button on a Gamepad: While holding Menu/Start, Double-Tap any button.",
