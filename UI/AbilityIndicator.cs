...
public class AbilityIndicator : MonoBehaviour
{
    ...
    public Vector3 offset = new(3f, 8f, 0f);
    ...
    private void Awake() => _activeInstanceCount++;
    ...
    private void UpdateGlowPulse()
    {
        ...
        currentColor.a *= (intensity / maxGlowIntensity); // Scale based on max intensity
    ...
    public void SetAvailableColor(Color c) => availableColor = c;

    public void SetCooldownColor(Color c) => cooldownColor = c;

    public void SetShowOnlyWhenReady(bool v) => showOnlyWhenReady = v;
